...
Introduce the object interface, configurable tension for slack and buffer, fixed next[0] handling, fixed/improved non-deterministic tests.

=item 0.1.8

Introduce commandline, compile mode and pre-scheduling safety checks.
